...
public class begenmediklerim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_begenmediklerim);
        getSupportActionBar().setTitle(" Beğenmediklerim");
        ...
        DatabaseReference myRef = database.getReference("/" + uid + "/unliked");
        myList = findViewById(R.id.movieNotLikedList);
